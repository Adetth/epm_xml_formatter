# Oracle EPM XML Multi-Tool

---

A robust, browser-based utility designed to automate, visualize, and manage layout formatting for Oracle EPM/EPBCS XML form exports. 
...
**Live Application:** [https://adetth.github.io/epm_xml_formatter/]
...
### 5. Console Log
* **Real-Time Debugging**: Features a custom DOM-based console that hijacks standard Python outputs (**sys.stdout** and **sys.stderr**), displaying full execution traces and error logs directly in the UI.
...
| :--- | :--- |
| **Core Engine** | PyScript (Python via WebAssembly/Pyodide) |
| **Frontend** | HTML5, CSS3, Vanilla JavaScript |
| **Parsing** | Python 3, **xml.etree.ElementTree** |
...
* **Dynamic Changelog**: The UI automatically fetches the latest version number from **changelog.txt** on page load.
* **Kill-Switch**: Includes a master boolean toggle (**APP_ACTIVATED**) at the top of the HTML file to instantly put the live site into Maintenance Mode.
